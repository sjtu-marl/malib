...
def test_single_external_dataset():
    ...
    single_agent_params = {
        ...
        "init_capacity": 10000,
        "other_columns": [
            "single_other_column1",
            "single_other_column2"
        ]
    }
    ...
    single_agent_data = {
        ...
        for column_name in
        default_columns + single_agent_params["other_columns"]
    }
    ...
    single_agent_table = Table(
        name=table_name,
        multi_agent=False
    )
    single_agent_table.set_episode(
        {single_agent_id: single_agent_episode},
        single_agent_episode.capacity
    )
    ...
    res, info = ray.get(offline_dataset_server.sample.remote(
        BufferDescription(
                env_id=single_agent_params["env_id"],
